    ...
    <div class="container-fluid">
        <div class="row align-items-center flex-row-reverse">
            <div class="col-xl-2 col-lg-3 col-md-4">
                <ul class="d-flex align-items-center justify-content-end gap-md-2 gap-1">
                    <li>
                        <a href="#mainContent" data-bs-toggle="tooltip" data-bs-placement="bottom"
                            aria-label="Skip to main content" title="Skip to Main Content">
                            <svg width="32" height="32" aria-label="Skip to main Content icon" viewBox="0 0 30 30"
                    ...
                    <li>
                        <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="bottom"
                            ...
                            <svg width="32" height="32" viewBox="0 0 24 24" fill="none"
                                aria-label="Accessibility panal icon" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <path
                                    ...
                                    fill="#1D0A69" class="jsx-1785232235"></path>
                                <path
            ...
            <div class="col-xl-5 col-lg-4 col-1 d-none d-lg-block">
            ...
            <div class="col-xl-5 col-lg-5 col-md-8">
                <div class="logo">
                    <a href="https://socialjustice.gov.in/" target="_blank"><img src="{{ asset('images/NHAA-LOGO.png') }}"
                            alt="National Emblem of India Satyamev Jayate" /></a>
                    <div class="name">
